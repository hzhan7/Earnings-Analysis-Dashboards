...
REACH_2016 = {
    "amd": 16, "amzn": 13, "arm": 0, "asml": 16, "avgo": 16, "axp": 11, "bc": 1, "cboe": 10, "cdns": 10, "cfr": 13, "cme": 14,
...
class ChartWindowTest(unittest.TestCase):
    ...
    def test_the_unfinished_exemptions_stay_visible(self) -> None:
        ...
        self.assertEqual(settled.count("disclosure"), 156)
        self.assertEqual(settled.count("design"), 41)
