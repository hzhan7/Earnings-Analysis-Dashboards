...
REACH_2016 = {
    "amd": 16, "amzn": 8 + _amzn_threshold_reach(), "arm": 0, "asml": 16, "avgo": 6, "axp": 11, "bc": 1, "cboe": 10, "cdns": 10, "cfr": 13, "cme": 14,
...
CONVERTED = {
    ...
    "amzn": {
        ...
        "AWS backlog 单季净增": "checked: Amazon has disclosed AWS-related unrecognized customer-contract commitments (original term over one year) in every 10-Q/10-K since the quarter ended 2018-03-31 (Q1 2018 10-Q 0001018724-18-000072: \"$12.4 billion as of March 31, 2018\"); the FY2017 10-K (0001018724-18-000005) and the Q3 2017 10-Q (0001018724-17-000135) print no such figure. All 34 quarters since are in the series, so 2018Q1 is the disclosure floor.",
        "AWS backlog 环比增速": "same disclosure floor as the net-addition chart: the balance "
                          "is first printed for 2018-03-31, so the first growth rate is 2018Q2.",
        "AWS backlog 余额": "same disclosure floor: the balance is first printed for 2018-03-31.",
...
FLOOR_KIND = {
    ...
    'amzn': {
        ...
        '北美分部经营利润率': 'coverage',
        '广告同比': 'disclosure',
        'AWS backlog 单季净增': 'disclosure',
        'AWS backlog 环比增速': 'disclosure',
        'AWS backlog 余额': 'disclosure',
...
class ChartWindowTest(unittest.TestCase):
    ...
    def test_the_unfinished_exemptions_stay_visible(self) -> None:
        ...
        self.assertEqual(len(by_kind.get("coverage", [])), 32,
