...
REACH_2016 = {
    "amd": 16, "amzn": 9 + _amzn_threshold_reach(), "arm": 0, "asml": 16, "avgo": 6, "axp": 11, "bc": 1, "cboe": 10, "cdns": 10, "cfr": 13, "cme": 14,
...
class ChartWindowTest(unittest.TestCase):
    ...
    def test_the_unfinished_exemptions_stay_visible(self) -> None:
        ...
        self.assertEqual(len(by_kind.get("coverage", [])), 30 + amzn["coverage"],
        ...
        self.assertEqual(settled.count("disclosure"), 160 + amzn["disclosure"])
        self.assertEqual(settled.count("design"), 42 + amzn["design"])
