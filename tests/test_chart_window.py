...
REACH_2016 = {
    ...
    "msci": 15, "msft": 8, "mu": 7, "ndaq": 9, "nke": 8, "nvda": 9 + _nvda_threshold_charts()[0], "pm": 6,
...
class ChartWindowTest(unittest.TestCase):
    ...
    def test_no_page_has_an_unexplained_short_axis_beyond_the_pinned_backlog(self) -> None:
        ...
        # NVIDIA's charts that roll with the page's stamped blocks are counted
        # live (above) and kept out of this site total.
        self.assertEqual(sum(SHORT_BY_DESIGN.values()) - _nvda_threshold_charts()[1], 46)
