...
def long_charts(staging: dict) -> tuple[list[dict], list[dict]]:
    ...
    capex_chart = {
        ...
        "src_extra": ("2019Q1 起取自各季业绩新闻稿的 Capex and R&D 表；2016Q1–2018Q4 由各季中报 6-K "
                      "附件的累计栏与 20-F 全年数还原 D。资本开支不含 IFRS 16 使用权资产 —— "
                      "这一条是由「采纳前后上年可比数未变」反推的，本页没有读到明文条款。"),
    }
