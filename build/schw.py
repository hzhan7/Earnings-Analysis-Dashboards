...
def build_payload(staging: dict) -> dict:
    ...
    return {
        ...
        "notes": [
            ...
            guidance["why_no_delivery_record"],
            "本页只发布季度口径，不发布月度数据。Schwab 每月中旬发布月度活动报告，其中的月度净新增资产、日均交易量、交易性 sweep 现金、新开经纪账户与保证金余额都是本季研究记录里权重最高的跟踪项。把它们画进来会让这一页在两次财报之间发生变化，而本站的内容边界要求每一页只按季度这一个节奏更新。因此第三节的阈值清单里，只有季度口径可核的六条接入，其余八条写明了不接入的理由。需要说明的是这不是无法聚合：本季四月至六月的月度 core 净新增资产 7.2 + 49.9 + 62.7 恰好等于公司自己公布的季度 core 净新增资产 US$119.8B，聚合是可核的 —— 不接入是节奏问题，不是数据问题。",
